            ...
            <div className='grid lg:grid-cols-[47.2%_auto] grid-cols-1 bg-home-bg-1'>
                <div className='xl:p-15 p-8'>
                    <form action={formAction}>
                        <strong className='lg:text-2xl text-xl font-semibold text-gray-1-foreground block lg:mb-7.5 mb-5'>Вход в личный кабинет</strong>
                        <Label htmlFor='email' className='text-gray-1-foreground text-base block mb-5'>
                            Email<span className='text-red-400'>*</span>
                            <Input type='email' placeholder='Введите email' name='email' id='email' required className='py-3 px-5 border-[#999796] border-[1.5px] placeholder:text-[#999796] text-gray-1-foreground mt-2.5' />
                        </Label>
                        <Label htmlFor='password' className='text-gray-1-foreground text-base block mb-5'>
                            Пароль<span className='text-red-400'>*</span>
                            <Input type='password' placeholder='Введите пароль' name='password' id='password' required className='py-3 px-5 border-[#999796] border-[1.5px] placeholder:text-[#999796] text-gray-1-foreground mt-2.5' />
                        </Label>
                        <div className='flex sm:flex-row flex-col justify-between sm:items-center gap-y-2'>
                            <div className='flex items-center gap-2.5'>
                                ...
                                <Label htmlFor="terms" className="text-base text-gray-1-foreground">Запомнить меня</Label>
                            </div>
                    ...
                    <p className='text-center mt-7.5 text-base text-gray-1-foreground'>Или войдите через</p>
                    ...
                    <p className='text-center mt-5 text-base text-gray-1-foreground'>Новый клиент? <Link href={"/register"} className='text-secondary-foreground font-medium'>Зарегистрироваться</Link></p>
                </div>
