...
const HeaderExtraInfo = () => {
    const showAny = featureFlags.showLanguageSelector || featureFlags.showCurrencySelector;
    
    if (!showAny) return null;
    
    return (
        <div className='flex lg:flex-row flex-col lg:items-center gap-5 mt-5 lg:mt-0'>
            {featureFlags.showCurrencySelector && (
                <Select defaultValue={featureFlags.defaultCurrency}>
            ...
            {featureFlags.showLanguageSelector && (
                <Select defaultValue={featureFlags.defaultLanguage}>
